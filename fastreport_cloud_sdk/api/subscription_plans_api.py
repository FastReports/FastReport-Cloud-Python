...
class SubscriptionPlansApi(object):
    ...
    def subscription_plans_get_subscription_plan(self, id, **kwargs):  # noqa: E501
        """Returns a subscription plan. Not all subscriptions can be issued for customer.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.subscription_plans_get_subscription_plan(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.subscription_plans_get_subscription_plan_with_http_info(id, **kwargs)  # noqa: E501

    def subscription_plans_get_subscription_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        """Returns a subscription plan. Not all subscriptions can be issued for customer.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.subscription_plans_get_subscription_plan_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method subscription_plans_get_subscription_plan" % key
                )
        ...
        if self.api_client.client_side_validation and 'id' in local_var_params and not re.search(r'^[A-Fa-f0-9]{24}$', local_var_params['id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `subscription_plans_get_subscription_plan`, must conform to the pattern `/^[A-Fa-f0-9]{24}$/`")  # noqa: E501
        collection_formats = {}
    ...
    def subscription_plans_get_subscription_plans(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.subscription_plans_get_subscription_plans(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.subscription_plans_get_subscription_plans_with_http_info(**kwargs)  # noqa: E501

    def subscription_plans_get_subscription_plans_with_http_info(self, **kwargs):  # noqa: E501
        """Returns a list of active subscription plans that can be issued to the user.  # noqa: E501
        ...
        >>> thread = api.subscription_plans_get_subscription_plans_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method subscription_plans_get_subscription_plans" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
