...
class EmailTaskVM(object):
    ...
    def __init__(self, body=None, enable_ssl=None, _from=None, is_body_html=None, port=None, server=None, subject=None, to=None, username=None, local_vars_configuration=None):  # noqa: E501
