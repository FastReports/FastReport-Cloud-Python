...
class TransformTaskBaseVM(object):
    ...
    def __init__(self, locale=None, input_file=None, output_file=None, transports=None, name=None, subscription_id=None, type=None, local_vars_configuration=None):  # noqa: E501
