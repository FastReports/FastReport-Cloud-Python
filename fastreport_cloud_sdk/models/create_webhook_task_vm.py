...
class CreateWebhookTaskVM(object):
    ...
    def __init__(self, endpoints=None, name=None, subscription_id=None, type=None, local_vars_configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateWebhookTaskVM):
            return False
