...
from fastreport_cloud_sdk.models.subscription_plans_vm import SubscriptionPlansVM  # noqa: E501
from fastreport_cloud_sdk.rest import ApiException

class TestSubscriptionPlansVM(unittest.TestCase):
    """SubscriptionPlansVM unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SubscriptionPlansVM
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = fastreport_cloud_sdk.models.subscription_plans_vm.SubscriptionPlansVM()  # noqa: E501
        if include_optional :
            return SubscriptionPlansVM(
                subscription_plans = [
                    fastreport_cloud_sdk.models.subscription_plan_vm.SubscriptionPlanVM(
                        id = '', 
                        is_active = True, 
                        display_name = '', 
    ...
    def testSubscriptionPlansVM(self):
        """Test SubscriptionPlansVM"""
